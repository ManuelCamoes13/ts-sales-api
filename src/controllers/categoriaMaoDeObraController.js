...
const categoriaService = require('../services/categoriaMaoDeObraService');

const criarCategoria = async (req, res) => {
    const { nome, unidade, estado } = req.body;

    try {
        const categoria = await categoriaService.criarCategoria(nome, unidade, estado);
...
const atualizarCategoria = async (req, res) => {
    ...
    try {
        const categoria = await categoriaService.atualizarCategoria(id, nome, unidade, estado);
